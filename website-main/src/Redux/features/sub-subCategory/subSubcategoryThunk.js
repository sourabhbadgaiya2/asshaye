...
const API_URL = "https://asshaye.onrender.com/subsubcategory"; // अपने API endpoint के हिसाब से बदलें
  ...
  async (subCategoryId, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `https://asshaye.onrender.com/subsubcategory/by-sub/${subCategoryId}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(
